...
import { AlertTriangle, CheckCircle2, Crown, Gauge } from "lucide-react";
...
export function UsageNotice({ usage }: { usage: UsageStatus | null }) {
  ...
  const Icon = isEmpty || isLow ? AlertTriangle : isFree ? Gauge : Crown;
        ...
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-xs text-muted">
              Plan {usage.planLabel}. Maximo por audio: {usage.maxAudioFileSizeMb}MB.
            </p>
          </div>
        </div>
